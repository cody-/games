	...
	: TexturedNode("bg-tech.jpg", size)
{
	...
	children_.push_back(unique_ptr<Node>(new Button("gear.png", btnRadius, {size.width - (btnOffsetX + 2*btnRadius), size.height - (btnOffsetX + 2*btnRadius)}, [&]{
		ButtonPressed(Btn::SETTINGS);
